            ...
            <form class="mt-8">
              ...
              <div class="mt-8">
                ...
                <div class="flex gap-4 max-md:flex-col mt-8">
                  ...
                  <button
                    type="button"
                    class="rounded-md px-6 py-3 w-full text-sm tracking-wide bg-gradient-to-r from-blue-500 to-purple-600 text-white"
                  >
                    Complete Purchase
                  </button>
                </div>
             ...
             <div class="bg-gradient-to-r from-[#314C88] to-[#303278] sm:h-screen sm:sticky sm:top-0 lg:min-w-[370px] sm:min-w-[300px]">
